                ...
                endpoints =>
                    {
                        ...
                        endpoints.MapControllerRoute( "Category", "/{name:minlength(5)}",new { controller = "Categories", action = "Category"});
